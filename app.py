...
TIME_LIMIT = 1.0 # How much time does AI-player have pr move?
...
def new_game():
    ...
    # data = {"grid": [[2, 4, 8, 16], [32, 64, 128, 512], [1024, 2048, 4096, 0], [0, 0, 0, 0]]}
    return data
...
def human_move():
    #direction = json.loads(request.form['direction'])
